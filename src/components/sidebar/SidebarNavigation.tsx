        ...
        {items.map(item => {
          ...
          return <Link 
            ...
            className={cn(
              ...
              isCollapsed ? "justify-center w-10 mx-auto transition-colors duration-200" : "px-3",
              isActive 
                ? isCollapsed ? "text-white" : "text-gray-900" 
                : isCollapsed ? "text-gray-400 hover:text-white" : "text-gray-400 hover:text-gray-900"
            )}
          >
