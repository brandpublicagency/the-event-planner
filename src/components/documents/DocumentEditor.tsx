...
import { Loader2, Save, FileDown, FileUp, Bold, Italic, Underline, Heading, Link, List, ListOrdered, SeparatorHorizontal } from "lucide-react";
...
export default function DocumentEditor({ documentId }: DocumentEditorProps) {
  ...
  const MenuButton = ({ onClick, active, icon: Icon, tooltip }: { onClick: () => void; active?: boolean; icon: any; tooltip: string }) => (
    <Button
      variant="ghost"
      size="sm"
