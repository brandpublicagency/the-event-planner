  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        cell: "relative p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-zinc-50 first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md",
        day: cn(
          "h-10 w-10 p-0 font-normal text-zinc-900 rounded-md border border-transparent",
