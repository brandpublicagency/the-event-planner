...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-6 mx-auto", className)}
      classNames={{
        ...
        day_outside: "text-primary-500 opacity-50 aria-selected:bg-primary-100/50 hover:bg-primary-100/50",
        day_disabled: "text-primary-500 opacity-50 hover:bg-transparent",
        day_range_middle:
